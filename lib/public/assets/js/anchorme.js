				...
				if (allAllowed) {
					...
					if (isurl) {
						...
						if (options.attributes) {
							splitedArray[i] = "<div style='display: inline;' contentEditable='false'><a target='_blank' style='color: blue;' href='" + url + "'";
							for (var name in options.attributes) {
								splitedArray[i] = splitedArray[i] + " " + name + "='" + options.attributes[name] + "' ";
							}
							splitedArray[i] = splitedArray[i] + ">" + nice + "</a></div>";
						}
						else {
							splitedArray[i] = "<div style='display: inline;' contentEditable='false'><a target='_blank' style='color: blue;' href='" + url + "'>" + nice + "</a></div>";
						}
					}
				}
			}
